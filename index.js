...
$(document).ready(function() {
  setTimeout(function(){
    ...
    $("#formpassword").on('keypress',function(e) {
    if(e.which == 13) {
        validForm();
    }
});
